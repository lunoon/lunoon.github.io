    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         new Date(2022, 5, 19), new Date(2022, 6, 2), null, 70, '1,20,21'],
         ['31', 'Zero Knowledge Proof allgemein', 'schreiben',
         new Date(2022, 6, 2), new Date(2022, 6, 16), null, 70, '1,20,21,30'],
         ['40', 'Related Work ZKP Anwendung/libs', 'sichten',
         new Date(2022, 6, 2), new Date(2022, 6, 16), null, 20, '30,31'],
         ...
         new Date(2022, 6, 9), new Date(2022, 7, 21), null, 20, '30'],
         ['6', 'Impl. Prototyp', 'dev',
