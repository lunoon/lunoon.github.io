    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         ...
         new Date(2022, 6, 1), new Date(2022, 9, 10), null, 90, '1,20,21,30'],
         ...
         new Date(2022, 7, 1), new Date(2022, 9, 14), null, 90, '40'],
         ['5', 'Concept/Doku Impl.', 'dev',
         new Date(2022, 8, 9), new Date(2022, 9, 31), null, 30, '30'],
         ['6', 'Impl. Prototyp', 'dev',
         new Date(2022, 8, 16), new Date(2022, 9, 31), null, 30, '30'],
         ['7', 'Auswertung der Konzeptionierung/Impl.', 'dev',
         new Date(2022, 10, 1), new Date(2022, 10, 8), null, 0, '30'],
         ['8', 'Future Work und Zusammenfassung', 'outlook',
         new Date(2022, 10, 8), new Date(2022, 12, 14), null, 10, '21,31,41,5,6,7'],
         ['9', 'Buffer', 'extra',
