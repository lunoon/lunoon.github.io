    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         ...
         new Date(2022, 8, 9), new Date(2022, 9, 30), null, 90, '30'],
         ['6', 'Impl. Prototyp', 'dev',
         new Date(2022, 8, 16), new Date(2022, 9, 30), null, 99, '30'],
         ['7', 'Auswertung der Konzeptionierung/Impl.', 'dev',
         new Date(2022, 10, 1), new Date(2022, 10, 14), null, 30, '30'],
         ['8', 'Future Work und Zusammenfassung', 'outlook',
         new Date(2022, 10, 15), new Date(2022, 10, 31), null, 20, '21,31,41,5,6,7'],
         ['9', 'Buffer', 'extra',
