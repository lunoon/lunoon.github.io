    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         new Date(2022, 5, 19), new Date(2022, 8, 10), null, 100, '1,20,21'],
         ['31', 'Zero Knowledge Proof allgemein', 'schreiben',
         new Date(2022, 6, 2), new Date(2022, 9, 16), null, 90, '1,20,21,30'],
         ['40', 'Related Work ZKP Anwendung/libs', 'sichten',
         new Date(2022, 6, 2), new Date(2022, 8, 10), null, 100, '30,31'],
