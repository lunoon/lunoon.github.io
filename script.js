    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         new Date(2022, 5, 19), new Date(2022, 9, 10), null, 100, '1,20,21'],
         ['31', 'Zero Knowledge Proof allgemein', 'schreiben',
         new Date(2022, 6, 2), new Date(2022, 6, 16), null, 90, '1,20,21,30'],
         ['40', 'Related Work ZKP Anwendung/libs', 'sichten',
         new Date(2022, 6, 2), new Date(2022, 9, 10), null, 100, '30,31'],
         ['41', 'Related Work ZKP Anwendung/libs', 'schreiben',
         new Date(2022, 8, 23), new Date(2022, 9, 14), null, 90, '40'],
         ['5', 'Concept/Doku Impl.', 'dev',
         new Date(2022, 8, 9), new Date(2022, 9, 18), null, 30, '30'],
         ['6', 'Impl. Prototyp', 'dev',
         new Date(2022, 8, 16), new Date(2022, 9, 20), null, 30, '30'],
         ['7', 'Auswertung der Konzeptionierung/Impl.', 'dev',
         new Date(2022, 9, 20), new Date(2022, 10, 14), null, 0, '30'],
         ['8', 'Future Work und Zusammenfassung', 'outlook',
         new Date(2022, 10, 15), new Date(2022, 10, 22), null, 10, '21,31,41,5,6,7'],
         ['9', 'Buffer', 'extra',
         new Date(2022, 10, 23), new Date(2022, 11, 24), null, 0, null],
