    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        ['20', 'Blockchain allgemein, Hintergrund', 'sichten',
         new Date(2022, 5, 3), new Date(2022, 5, 10), null, 0, '1'],
         ['21', 'Blockchain allgemein, Hintergrund', 'schreiben',
         new Date(2022, 5, 11), new Date(2022, 5, 18), null, 0, '1,20'],
        ['30', 'Zero Knowledge Proof allgemein', 'sichten',
         new Date(2022, 5, 19), new Date(2022, 6, 2), null, 0, '1,20,21'],
         ['31', 'Zero Knowledge Proof allgemein', 'schreiben',
         new Date(2022, 6, 2), new Date(2022, 6, 16), null, 0, '1,20,21,30'],
         ['40', 'Related Work ZKP Anwendung/libs', 'sichten',
         new Date(2022, 6, 2), new Date(2022, 6, 16), null, 0, '30,31'],
         ['41', 'Related Work ZKP Anwendung/libs', 'schreiben',
         new Date(2022, 8, 23), new Date(2022, 9, 14), null, 0, '40'],
         ['5', 'Konzeption/Lösungsansatz Impl.', 'dev',
         new Date(2022, 6, 9), new Date(2022, 7, 21), null, 0, '30'],
         ['6', 'Impl. Prototyp', 'dev',
